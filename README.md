...
This utility is used by [OctoGuide](https://github.com/JoshuaKGoldberg/OctoGuide), a linter for GitHub repository activity, to power its [`comment-meaningful`](https://octo.guide/rules/comment-meaningful) rule.
That rule automatically posts a friendly reply to seemingly meaningless comments with suggestions to help the commenter understand why posting them is not helpful.
